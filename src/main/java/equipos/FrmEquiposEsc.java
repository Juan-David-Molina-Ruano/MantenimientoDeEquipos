    ...
    public class FrmEquiposEsc extends javax.swing.JFrame {
        ...
        private Equipo obtenerDatos() {
            ...
            try {
                String[] partesFecha = jTxtFechaAd.getText().split("/"); // Dividir la fecha con plecas
                int dia = Integer.parseInt(partesFecha[0]);
                int mes = Integer.parseInt(partesFecha[1]);
                int año = Integer.parseInt(partesFecha[2]);
                LocalDate fecha = LocalDate.of(año, mes, dia); // Crear un objeto LocalDate
                DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd/MM/yyyy");
                String fechaFormateada = fecha.format(formatter); // Convertir LocalDate a String en el formato deseado
                equipo.setFechaAdqui(fechaFormateada);
            } catch (Exception e) {
        ...
        private void asingarDatos(Equipo equipo) {
            ...
            String[] partesFecha = equipo.getFechaAdqui().split("/");
            int dia = Integer.parseInt(partesFecha[0]);
            int mes = Integer.parseInt(partesFecha[1]);
            int año = Integer.parseInt(partesFecha[2]);
            LocalDate fechaAdquisicion = LocalDate.of(año, mes, dia);
            if (fechaAdquisicion != null) {
                DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd/MM/yyyy");
                String fechaAdquisicionStr = fechaAdquisicion.format(formatter);
                jTxtFechaAd.setText(fechaAdquisicionStr);
            }
